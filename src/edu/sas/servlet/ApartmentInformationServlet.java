...
public class ApartmentInformationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Apartment apartment = DAOFactory.getIApartmentDAOInstance().findById(apartno);
			request.setAttribute("apartment", apartment);
			request.getRequestDispatcher("apartment-information.jsp").forward(request, response);
		} catch (Exception e) {
